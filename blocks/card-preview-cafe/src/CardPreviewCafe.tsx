...
export default function CardReviewCafe() {
  ...
  return (
    <Card sx={{ borderRadius: "25px", p: 3, pb: 2 }}>
      <Typography level="title-lg">Cafe Terbaru</Typography>
      <CardContent
      ...
      >
        ...
        <Stack justifyContent="space-between" sx={{ width: "100%" }}>
          <Stack direction="row" justifyContent="space-between">
            <Typography
              level="body-sm"
              startDecorator={<LocationIcon fontSize="sm" />}
            ...
            <Typography
              level="body-sm"
              startDecorator={<StarIcon sx={{ color: "warning.400" }} />}
              textColor="text.primary"
              sx={{ mr: 3 }}
            >
              4.8
          ...
          <Stack>
            <Typography fontWeight="lg">Kopi & Kitchen</Typography>
            <Typography fontWeight="lg">Sekaran</Typography>
          </Stack>
          ...
          >
            <Typography level="body-sm" startDecorator={<ClockIcon />}>
              Buka
            </Typography>
            <CircleIcon sx={{ fontSize: 7, color: "background.level3" }} />
      ...
      <CardActions sx={{ flexDirection: "column", pt: 1 }}>
        <Button
          ...
          endDecorator={<RightArrowIcon fontSize="sm" />}
        >
          Lihat Detail
        </Button>
        <Stack
        ...
        >
          ...
          />
          <IconButton sx={{ minWidth: "unset", minHeight: "unset", p: "4px" }}>
            <CircleIcon sx={{ fontSize: 7, color: "background.level3" }} />
          </IconButton>
          <IconButton sx={{ minWidth: "unset", minHeight: "unset", p: "4px" }}>
            <CircleIcon sx={{ fontSize: 7, color: "background.level3" }} />
